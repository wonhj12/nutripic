...
class RecipeFinishView extends StatelessWidget {
      ...
      body: Stack(
        ...
        children: [
          Column(
            ...
            children: [
              Container(height: 102, color: Palette.green500),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color:
                                const Color(0xFFC2C0CB).withValues(alpha: 0.3),
                      ...
                      onPressed: () {
                        recipeFinishViewModel.filterSelectedFoods.isNotEmpty ||
                                recipeFinishViewModel
                                    .filterSelectedExpiredFoods.isNotEmpty
                            ? _showConfirmationDialog(
                                context,
                                recipeFinishViewModel,
                                recipeFinishViewModel.deleteFoods)
  ...
  void _showConfirmationDialog(BuildContext context,
      RecipeFinishViewModel viewModel, Function()? onTapConfirm) {
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              ...viewModel.filterSelectedExpiredFoods.map((food) {
                return Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(food.name),
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () async {
                    // 선택한 음식을 삭제
                    await onTapConfirm?.call();

                    Navigator.pop(context); // 다이얼로그 닫기

                    context.go('/refrigerator'); // 다이얼로그 닫기
                    // 화면 닫기
                  },
                  child: const Text('확인'),
                ),
