...
import 'package:nutripic/components/recipe/recipe_tile.dart';
    ...
    return Scaffold(
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                InkWell(
                  onTap: recipeSearchViewModel.onRecipeView,
                  child: Column(
      ...
      body: Column(
        children: [
          ...
          // ),
          Expanded(
            child: recipeSearchViewModel.filteredRecipes.isEmpty
                ? const Center(child: Text('검색 결과가 없습니다.'))
                : ListView.builder(
                    itemCount: recipeSearchViewModel.filteredRecipes.length,
